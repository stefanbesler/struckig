hljs.registerLanguage("iecst",(()=>{return e=>({
aliases:["iecst","scl","stl","structured-text"],name:"Structured Text iecst",
...
hljs.registerLanguage("st",(()=>{return e=>({
...
hljs.registerLanguage("lang-st",(()=>{return e=>({
aliases:["lang-st"],name:"Structured Text lang-st",
case_insensitive:!0,keywords:{
keyword:"if then end_if elsif else case of end_case to do by while repeat end_while end_repeat for end_for from public private protected or and not xor le ge eq ne ge lt constant return exit at retain non_retain task with until using extend",
title:"program end_program function end_function function_block end_function_block configuration end_configuration action end_action transition end_transition type end_type struct end_struct initial_step namespace end_namespace channel end_channel library end_library folder end_folder resource end_resource var var_global end_var var_input VAR_EXTERNAL var_out var_output var_in_out var_temp var_interval var_access var_config method end_method property end_property interface end_interface",
literal:"false true null ",
...
hljs.registerLanguage("pascal",(()=>{return e=>({
aliases:["pascal"],name:"Structured Text pascal",
case_insensitive:!0,keywords:{
keyword:"if then end_if elsif else case of end_case to do by while repeat end_while end_repeat for end_for from public private protected or and not xor le ge eq ne ge lt constant return exit at retain non_retain task with until using extend",
title:"program end_program function end_function function_block end_function_block configuration end_configuration action end_action transition end_transition type end_type struct end_struct initial_step namespace end_namespace channel end_channel library end_library folder end_folder resource end_resource var var_global end_var var_input VAR_EXTERNAL var_out var_output var_in_out var_temp var_interval var_access var_config method end_method property end_property interface end_interface",
literal:"false true null ",
...
hljs.registerLanguage("lang-pascal",(()=>{return e=>({
aliases:["lang-pascal"],name:"Structured Text lang-pascal",
case_insensitive:!0,keywords:{
keyword:"if then end_if elsif else case of end_case to do by while repeat end_while end_repeat for end_for from public private protected or and not xor le ge eq ne ge lt constant return exit at retain non_retain task with until using extend",
title:"program end_program function end_function function_block end_function_block configuration end_configuration action end_action transition end_transition type end_type struct end_struct initial_step namespace end_namespace channel end_channel library end_library folder end_folder resource end_resource var var_global end_var var_input VAR_EXTERNAL var_out var_output var_in_out var_temp var_interval var_access var_config method end_method property end_property interface end_interface",
literal:"false true null ",
